...
<head>
    ...
    <title>Admin Courses | Buy Argumentative Essay</title>
...
<div class="layout">
    <aside class="sidebar">
        ...
        <div class="nav-group">
            ...
            <a class="nav-link active" href="{{ route('admin.courses') }}">Courses</a>
        </div>
        <div class="nav-group">
    ...
    <main class="content">
        <div class="topbar">
            <div>
                <div style="font-size:14px; color:var(--muted); font-weight:700;">Courses</div>
                <div style="font-size:24px; font-weight:900;">Manage Course Categories</div>
            </div>
